   ...
   <div class="card-body">
      <div class="card m-2">
         ...
         <div class="card-body">
           ...
           <form  class="m-2" action="${pageContext.request.contextPath}/ch02/method" method="get">
          		bkind : <input type=text" name="bkind" value="free"/><br/>
          		bno : <input type="text" name="bno" value="1">
           ...
           <hr/>
            <form  class="m-2" action="${pageContext.request.contextPath}/ch02/method" method="post">
          		bkind : <input type=text" name="bkind" value="free"/><br/>
          		bno : <input type="text" name="bno" value="1">
