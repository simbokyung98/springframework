...
<!-- taglib : 태그 라이브러리 / prefix : 접두사 / uri : 사용할 namespace uri  -> error 가져올 태그 -->
...
<div class="card m-2">
   ...
   <div class="card-body">
      ...
      <div class="card m-2">
         ...
         <div class="card-body">
            <form id="form0" method="post" action="method1" onsubmit="checkData(this)" ><!-- (this) = event.target -> 현재 이벤트 발생한 객체(form) -->
         ...
         <script>
            function checkData(form) {
            	//let form = event.target;[상단 매개변수에 form으로 this를 받은것과 동일]
            	
               //form의 제출 기능을 off -> 서버 요청 막기
               ...
               if(param2 === "") {
                  ...
                  const pattern = /^(010|011)-\d{3,4}-[0-9]{4}$/;
