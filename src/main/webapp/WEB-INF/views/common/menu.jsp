...
<ul class="nav flex-column">
	<li class="nav-item mb-2">
		<h6 class="text-white">
			...
			<a href="${pageContext.request.contextPath}/ch01/content" class="text-white"> Development </a>
		</h6>
	</li>
	<li class="nav-item mb-2">
		<h6 class="text-white">
	...
	<li class="nav-item mb-2">
		<h6 class="text-white">
			...
			<a href="${pageContext.request.contextPath}/ch07/content" class="text-white">Controller/Forward & Redirect</a>
		</h6>
	</li>
</ul>